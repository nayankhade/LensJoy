        ...
        <Container>
          <Row>
            <Col sm={6} md={3} className="item">
              <h3>Services</h3>
              <ul>
                <li><a href="#">Home Eye Check-Up</a></li>
                <li><a href="#">Frame Trial at Home</a></li>
            ...
            <Col sm={6} md={3} className="item">
              ...
              <ul>
                ...
                <li><a href="#">Team : 3 Gropu of Team</a></li>
          ...
          <p className="copyright">LensJoy © 2023</p>
        </Container>
      </footer>
    </div>
  );
